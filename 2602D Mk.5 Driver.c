...
#pragma config(Motor,  port2,           pincherR,      tmotorNone, openLoop)
#pragma config(Motor,  port3,           pincherL,      tmotorVex393_MC29, openLoop, reversed, driveRight)
#pragma config(Motor,  port4,           armR1,         tmotorVex393_MC29, openLoop, driveLeft)
...
task main()
{
  ...
  while (true)
  {
  	...
  	else
  	{
		...
		motor[chassisR]= Ch2Value;
		motor[chassisL] = Ch3Value;
